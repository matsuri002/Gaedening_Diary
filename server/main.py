...
def add_date(
    ...
    try:
        ...
        service.permissions().create(fileId=photo_drive_id, body=permission).execute()
        file = service.files().get(fileId=photo_drive_id, fields='webViewLink').execute()
        photo_shared_link = file['webViewLink']
