...
return (
  <div id="today" className="today-container">
  ...
  <div id="memo-set" className="memo-set">
    <div className="memo-form-container">
      <div className="memo-section">
         
      <div className="memo-section">
      <button className="memo-button" onClick={handleShowMemoForm}>メモ</button>
    {showMemoForm && (
    <div className="memo-input-container">
      <textarea id="memo" name="memo" rows="2" cols="30" value={memo} onChange={handleMemoChange}></textarea>
      <button onClick={handleHideMemoForm}>完了</button>
    </div>
  )}
</div>
<Link to="/"><button className="diary-back-botton">戻る</button></Link>
    ...
    <button className="form-button" onClick={handleShowForm}>登録</button>
  {showForm && (
